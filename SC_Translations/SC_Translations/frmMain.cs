...
namespace SC_Translations
{
    public partial class frmMain : Form
    {
        ...
        private void btUpgrade_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("English Global File Not found!", "SC Upgrade Translation Tool - Upgrading", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            if ((txtLangPath.Text == "") || (File.Exists(txtLangPath.Text)))
            {
                MessageBox.Show("Language Global File Not found!", "SC Upgrade Translation Tool - Upgrading", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
